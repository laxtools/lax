...
#define INTERNAL_CATCH_TESTCASE2_DISABLE( TestName, ... ) \
		static void TestName()

#define INTERNAL_CATCH_TESTCASE( ... ) \
        INTERNAL_CATCH_TESTCASE2( INTERNAL_CATCH_UNIQUE_NAME( ____C_A_T_C_H____T_E_S_T____ ), __VA_ARGS__ )

#define INTERNAL_CATCH_TESTCASE_DISABLE( ... ) \
        INTERNAL_CATCH_TESTCASE2_DISABLE( INTERNAL_CATCH_UNIQUE_NAME( ____C_A_T_C_H____T_E_S_T____ ), __VA_ARGS__ )
...
#define TEST_NONE( ... ) INTERNAL_CATCH_TESTCASE_DISABLE( __VA_ARGS__ )
